    ...
    <main className="min-h-screen bg-white text-[#1B263B] antialiased selection:bg-[#F4D35E]/30 font-sans overflow-hidden">
      ...
      <section className="bg-gradient-to-r from-[#1B263B] to-[#415A77] text-white py-24 md:py-32 text-center">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            TutionZone is Bangladesh&apos;s premier platform designed to connect
            ambitious learners with world-class educators. We make finding the
            right mentor simple, safe, and efficient.
          </motion.p>
        </div>
      </section>
          ...
          >
            <motion.div variants={fadeIn} className="space-y-6">
              ...
              <p className="text-gray-900 text-2xl font-bold leading-tight">
                To democratize quality education in Bangladesh by providing a
                transparent and secure platform.
              </p>
              <p className="text-gray-500 font-light leading-relaxed">
                We believe every student deserves a mentor who understands their
                unique learning pace. Our mission is to make finding that mentor
                effortless and safe.
              </p>
            </motion.div>
            <motion.div variants={fadeIn} className="space-y-6">
              ...
              <p className="text-gray-500 text-lg font-light leading-relaxed">
                To become the most trusted global destination for personalized
                learning, where technology and human expertise create limitless
                possibilities.
              </p>
            </motion.div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
            {loading
              ? [...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="h-12 bg-gray-50 animate-pulse rounded"
                  />
                ))
              : stats.map((stat, i) => (
                  <motion.div
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="max-w-xl mx-auto text-gray-400 text-lg md:text-xl font-light mb-12 italic">
              Join the most trusted education network and unlock your potential
              today.
            </p>
