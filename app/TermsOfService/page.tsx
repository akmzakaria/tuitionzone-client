          ...
          <section>
            ...
            >
              <p className="text-sm italic" style={{ color: theme.colors.text }}>
                TuitionZoneBD typically charges a one-time commission from the first month’s salary.
                Attempting to bypass the platform after a lead has been shared is a breach of these
                terms.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-sm" style={{ color: theme.colors.lightText }}>
                ...
                <span className="block font-semibold mt-1" style={{ color: theme.colors.primary }}>
